/****************************************************************************
While the underlying libraries are covered by LGPL, the original codebase sample 
was released as public domain.  It was distributed in the hope that it will be useful, but 
WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY 
or FITNESS FOR A PARTICULAR PURPOSE. The original was part of the DxSnap Example for
C# DirectShow.
 * 
 * 
 * This code has been slightly modified from its original version specifically for the
 * RockShot product for the Smithsonian Institution.
*****************************************************************************/
...
namespace RockShot
{
    ...
    internal class Capture : ISampleGrabberCB, IDisposable
    {
        ...
        public Capture(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl)
        {
            ...
            {
                iDeviceNum = capDevices.Length - 1;
        ...
        private void ConfigVideoWindow(Control hControl)
        {
            ...
            hr = ivw.SetWindowPosition( 1, 1, rc.Right, rc.Bottom );
            DsError.ThrowExceptionForHR( hr );
        }
